 ...
 * 
 */
public class ParsedRequestMessage implements RequestMessage<String> {

    private static final Logger logger = LoggerFactory.getLogger(ParsedRequestMessage.class);

    private final RequestMessage<String> mesg;

    private final String meta;
    private final String resource;
    private final QueryStringDecoder queryStringDecoder;

    public ParsedRequestMessage(RequestMessage<String> mesg) {
        this.mesg = mesg;
    ...
    @Override
    public RequestMessage<String> setSenderInfo(NodeAddress senderInfo) {
    ...
    @Override
    public Message<String> setId(Integer id) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public RequestMessage<String> setTargetService(String targetService) {
        throw new UnsupportedOperationException();
    }
