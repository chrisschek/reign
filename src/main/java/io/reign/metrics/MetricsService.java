...
public class MetricsService extends AbstractService {
    ...
    MetricsData getMetricsFromDataNode(String clusterId, String serviceId, String dataNode) {
        ...
        try {
            ...
            logger.info("getMetricsFromDataNode():  dataPath={}; data={}", dataPath,
                    ...
                    try {
                        ...
                        for (String dataNode : dataNodes) {
                            try {
                                ...
                                boolean dataTooOld = currentTimestamp - metricsData.getIntervalStartTimestamp() > metricsData
                                        .getIntervalLengthUnit().toMillis(metricsData.getIntervalLength()) * 12;
