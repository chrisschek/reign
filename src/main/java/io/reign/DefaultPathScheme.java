...
public class DefaultPathScheme implements PathScheme {
    ...
    @Override
    public String firstToken(String path) {
        return path.substring(0, path.indexOf(getPathDelimiter()));
    }

    @Override
    public String lastToken(String path) {
        return path.substring(path.lastIndexOf(getPathDelimiter()) + 1);
    }
