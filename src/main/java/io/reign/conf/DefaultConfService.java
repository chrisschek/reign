 ...
 * 
 */
public class DefaultConfService extends AbstractService implements ConfService {

    static final DataSerializer DEFAULT_CONF_SERIALIZER = new JsonDataSerializer();

    private static final Logger logger = LoggerFactory.getLogger(DefaultConfService.class);

    private final ZkClientUtil zkUtil = new ZkClientUtil();

    public DefaultConfService() {
    }
