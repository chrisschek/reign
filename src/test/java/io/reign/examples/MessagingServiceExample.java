...
public class MessagingServiceExample {
    ...
    public static void messagingExample(Reign reign) throws Exception {
        ...
        byte[] bytes = "/examples".getBytes("UTF-8");
        ResponseMessage response = messagingService.sendMessageSingleNode("examples", "service1",
                new SimpleRequestMessage("null", bytes));

        logger.info("BINARY Broadcast#1:  response={}; messageAsString={}; bytes.length={}", response, new String(
