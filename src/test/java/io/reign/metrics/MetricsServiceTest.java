...
public class MetricsServiceTest {
    ...
    public void testIntervalNodes() throws Exception {
        ...
        logger.debug("MY! metricsData.counter(c1)={}", metricsService.getNodeMetrics("clusterMetrics", "serviceD")
                .getCounter("c1")
                .getCount());
    ...
    public void testExportSelfMetrics() throws Exception {
        ...
        while (metricsData == null) {
            metricsData = metricsService.getNodeMetrics("clusterMetrics", "serviceA");
            Thread.sleep(1000);
        }
        ...
        assertTrue("Unexpected value:  " + timer1.getMax(), timer1.getMax() < 150);
        assertTrue("Unexpected value:  " + timer2.getMax(), timer2.getMax() < 250);
